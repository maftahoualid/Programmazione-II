...
public abstract class TicTacToe {
     ...
     */
    private final Tile[] board = { Tile.EMPTY, Tile.EMPTY, Tile.EMPTY, Tile.EMPTY, Tile.EMPTY, Tile.EMPTY, Tile.EMPTY,
     ...
     * @throws java.lang.IllegalArgumentException se le coordinate non sono fra 1 e
     *                                            3
     */
     ...
     * @param x      l'ascissa della casella, fra 1 e 3
     * @param y      l'ordinata della casella, fra 1 e 3
     * @throws java.lang.IllegalStateException    se il gioco è già finito, oppure
     *                                            se non tocca
     *                                            a player giocare, oppure se chi fa
     *                                            la prima mossa cerca di fare anche
     *                                            la seconda
     * @throws java.lang.IllegalArgumentException se le coordinate non sono fra 1 e
     *                                            3,
     *                                            oppure se la casella (x,y) e' gia'
     *                                            occupata
     */
     ...
     * dipende dalle sottoclassi di questa classe. Ogni sottoclasse puo'
     * implementare
