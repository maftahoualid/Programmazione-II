# Lezione del 2/10/2024, 13:30 - 14:30, aula Magna
...
Introduzione al corso. Storia di Java. Bytecode. JDK e JRE. Concetto di programmazione ad oggetti: ereditarietà, incapsulazione e polimorfismo. Compilazione ed esecuzione da linea di comando. Primo esempio di programma Java. Istruzioni di stampa. Compilazione ed esecuzione dello
stesso programma usando l’ambiente Eclipse. Tipi primitivi ( boolean, char, byte, short, int,
long, float e double). Dichiarazione di variabili e costanti (final). Inizializzazione obbligatoria
delle variabili locali prima di venire lette. Operazioni aritmetiche. Operazioni aritmetiche ibride.
Assegnamento. Assegnamento composto. Pre e post incremento/decremento.

## Materiali Didattici ed Esercizi

### Esempi

- 💻 [**`Hello.java`**](esempi/Hello.java)
- 💻 [**`Variabili.java`**](esempi/Variabili.java)
...
<nav class="lesson-nav" style="position: fixed; top: 24px; right: 20px; width: 125px; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', 'Noto Sans', Helvetica, Arial, sans-serif; font-size: 11px; line-height: 1.45; border-left: 1px solid #d0d7de; padding-left: 10px; z-index: 100;">
  ...
  <div style="display: flex; gap: 8px; margin-bottom: 8px; font-size: 10px; color: #656d76;">
    <a href="../01_Introduzione/README.md" style="color: #0969da; text-decoration: none;" title="Programmazione II - Introduzione">← Prec</a>
    <span style="color: #d0d7de;">|</span>
    <a href="../03_Lezione_2024-10-03/README.md" style="color: #0969da; text-decoration: none;" title="Lezione del 3/10/2024, ore 16:30 - 18:30, aula Magna">Succ →</a>
  </div>
  <ul style="list-style: none; margin: 0; padding: 0; max-height: calc(100vh - 80px); overflow-y: auto; scrollbar-width: thin;">
    ...
    <li style="margin: 2px 0; font-weight: 600; color: #0969da; white-space: nowrap; overflow: hidden; text-overflow: ellipsis;" title="Lezione del 2/10/2024, 13:30 - 14:30, aula Magna">02. 02/10</li>
