# Lezione del 3/10/2024, ore 16:30 - 18:30, aula Magna
...
Lettura dell’input da tastiera tramite classe java.util.Scanner. Importazione delle classi di
libreria (java.lang è sempre importato per default). Istruzioni if, while, do, for e switch:
quasi identiche a quelle del linguaggio C.Identità delle stringhe (==) e uguaglianza delle stringhe (equals()). Operatore di concatenazione fra stringhe + e conseguente uso implicito dei
metodi concat() e valueOf() di java.lang.String. Concetto di classe e oggetto. Creazione di un oggetto dalla sua classe con l’operatore new. Il caso speciale dei letterali di tipo java.lang.String. Concetto di metodo: inviato a un oggetto (metodo d’istanza) o inviato a una
classe (metodo statico). Sintassi della chiamata di metodo. Garbage e garbage collection.

### Metodi di uso frequente della classe di libreria java.lang.String (classe immutabile,

nel senso che i suoi oggetti non sono più modificabili dopo la creazione)
...
- 💻 [**`Alfabeto.java`**](esempi/Alfabeto.java)
- 💻 [**`Curioso.java`**](esempi/Curioso.java)
- 💻 [**`Pappagallo.java`**](esempi/Pappagallo.java)
...
- [System](https://docs.oracle.com/javase/9/docs/api/java/lang/System.html)
...
<nav class="lesson-nav" style="position: fixed; top: 24px; right: 20px; width: 125px; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', 'Noto Sans', Helvetica, Arial, sans-serif; font-size: 11px; line-height: 1.45; border-left: 1px solid #d0d7de; padding-left: 10px; z-index: 100;">
  ...
  <div style="display: flex; gap: 8px; margin-bottom: 8px; font-size: 10px; color: #656d76;">
    <a href="../02_Lezione_2024-10-02/README.md" style="color: #0969da; text-decoration: none;" title="Lezione del 2/10/2024, 13:30 - 14:30, aula Magna">← Prec</a>
    <span style="color: #d0d7de;">|</span>
    <a href="../04_Laboratorio_2024-10-04/README.md" style="color: #0969da; text-decoration: none;" title="Laboratorio del 4/10/2024, 12:30 - 14:30, aula Delta">Succ →</a>
  </div>
  <ul style="list-style: none; margin: 0; padding: 0; max-height: calc(100vh - 80px); overflow-y: auto; scrollbar-width: thin;">
    ...
    <li style="margin: 2px 0; font-weight: 600; color: #0969da; white-space: nowrap; overflow: hidden; text-overflow: ellipsis;" title="Lezione del 3/10/2024, ore 16:30 - 18:30, aula Magna">03. 03/10</li>
