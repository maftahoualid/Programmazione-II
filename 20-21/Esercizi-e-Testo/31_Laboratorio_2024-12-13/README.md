# Laboratorio del 13/12/2024, ore 12:30 - 14:30, aula Delta
...
Ƃ Compito del 18-2-2019.pdf

## Materiali Didattici ed Esercizi

### Risorse e Documenti

- 📄 [**Compito del 18-2-2019.pdf**](consegna/compito.pdf)

### File di partenza

- 💻 [**`AudioBook.java`**](file_partenza/AudioBook.java)
- 💻 [**`Book.java`**](file_partenza/Book.java)
- 💻 [**`Catalog.java`**](file_partenza/Catalog.java)
- 💻 [**`CatalogWithStatistics.java`**](file_partenza/CatalogWithStatistics.java)
- 💻 [**`Genre.java`**](file_partenza/Genre.java)
- 💻 [**`Main.java`**](file_partenza/Main.java)
- 💻 [**`PaperBook.java`**](file_partenza/PaperBook.java)
- 💻 [**`risultato_main.txt`**](file_partenza/risultato_main.txt)

### Soluzione

- 💻 [**`AudioBook.java`**](soluzione/AudioBook.java)
- 💻 [**`Book.java`**](soluzione/Book.java)
- 💻 [**`ByAuthor.java`**](soluzione/ByAuthor.java)
- 💻 [**`ByYear.java`**](soluzione/ByYear.java)
- 💻 [**`Catalog.java`**](soluzione/Catalog.java)
- 💻 [**`CatalogWithStatistics.java`**](soluzione/CatalogWithStatistics.java)
- 💻 [**`Genre.java`**](soluzione/Genre.java)
- 💻 [**`Main.java`**](soluzione/Main.java)
- 💻 [**`PaperBook.java`**](soluzione/PaperBook.java)
...
<nav class="lesson-nav" style="position: fixed; top: 24px; right: 20px; width: 125px; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', 'Noto Sans', Helvetica, Arial, sans-serif; font-size: 11px; line-height: 1.45; border-left: 1px solid #d0d7de; padding-left: 10px; z-index: 100;">
  ...
  <div style="display: flex; gap: 8px; margin-bottom: 8px; font-size: 10px; color: #656d76;">
    <a href="../30_Lezione_2024-12-12/README.md" style="color: #0969da; text-decoration: none;" title="Lezione del 12/12/2024, ore 16:30 - 18:30, aula Magna">← Prec</a>
    <span style="color: #d0d7de;">|</span>
    <a href="../32_Lezione_2024-12-18/README.md" style="color: #0969da; text-decoration: none;" title="Lezione del 18/12/2024, ore 13:30 - 14:30, aula Magna">Succ →</a>
  </div>
  <ul style="list-style: none; margin: 0; padding: 0; max-height: calc(100vh - 80px); overflow-y: auto; scrollbar-width: thin;">
    ...
    <li style="margin: 2px 0; font-weight: 600; color: #0969da; white-space: nowrap; overflow: hidden; text-overflow: ellipsis;" title="Laboratorio del 13/12/2024, ore 12:30 - 14:30, aula Delta">31. Lab 13/12</li>
