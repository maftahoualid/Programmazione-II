# Lezione del 4/12/2024, ore 13:30 - 14:30, aula Magna
...
L’interfaccia java.lang.Iterable<E> e suo utilizzo nel ciclo for each. Il framework Collections della libreria standard. Le interfacce java.util.Collection<E>, java.util.List<E>,
java.util.Queue<E> e java.util.Set<E> del framework Collections. Le classi di libreria java.util.ArrayList<E>, java.util.Vector<E> (deprecata!), java.util.LinkedList<E> (sia
lista che coda FIFO) e java.util.PriorityQueue<E> (coda a priorità). Costruzione di una lista
con i factory method.
...
### Metodi di uso frequente dell’interfaccia java.util.List<E> (oltre a quelli ereditati da
...
### Metodi di uso frequente dell’interfaccia java.util.Queue<E> (oltre a quelli ereditati

da java.util.Collection<E>)
...
- `E element() throws java.util.NoSuchElementException` *(ritorna la testa della coda, senza rimuoverla; se la code è vuota, lancia un’eccezione)*
...
### Metodi di uso frequente dell’interfaccia java.util.Set<E> (oltre a quelli ereditati da
...
### Metodi di uso frequente della classe java.util.PriorityQueue<E> (oltre a quelli ereditati da java.util.Queue<E>). Si tratta di una coda unbounded: non ha un limite

massimo di elementi ma si espande quando necessario.
- `PriorityQueue` *()*
...
![Gerarchia delle collezioni](immagini/Collection_hierarchy.png)

## Materiali Didattici ed Esercizi

### Esempi

- 💻 [**`MainArraylist.java`**](esempi/MainArraylist.java)
- 💻 [**`MainLinkedList.java`**](esempi/MainLinkedList.java)
- 💻 [**`MainPriorityQueue.java`**](esempi/MainPriorityQueue.java)
- 💻 [**`MainPriorityQueue2.java`**](esempi/MainPriorityQueue2.java)
...
- [List](https://docs.oracle.com/javase/9/docs/api/java/util/List.html)
...
- [PriorityQueue](https://docs.oracle.com/javase/9/docs/api/java/util/PriorityQueue.html)
...
<nav class="lesson-nav" style="position: fixed; top: 24px; right: 20px; width: 125px; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', 'Noto Sans', Helvetica, Arial, sans-serif; font-size: 11px; line-height: 1.45; border-left: 1px solid #d0d7de; padding-left: 10px; z-index: 100;">
  ...
  <div style="display: flex; gap: 8px; margin-bottom: 8px; font-size: 10px; color: #656d76;">
    <a href="../25_Laboratorio_2024-11-22/README.md" style="color: #0969da; text-decoration: none;" title="Laboratorio del 22/11/2024, ore 12:30 - 14:30, aula Delta">← Prec</a>
    <span style="color: #d0d7de;">|</span>
    <a href="../27_Lezione_2024-12-05/README.md" style="color: #0969da; text-decoration: none;" title="Lezione del 5/12/2024, ore 16:30 - 18:30, aula Magna">Succ →</a>
  </div>
  <ul style="list-style: none; margin: 0; padding: 0; max-height: calc(100vh - 80px); overflow-y: auto; scrollbar-width: thin;">
    ...
    <li style="margin: 2px 0; font-weight: 600; color: #0969da; white-space: nowrap; overflow: hidden; text-overflow: ellipsis;" title="Lezione del 4/12/2024, ore 13:30 - 14:30, aula Magna">26. 04/12</li>
