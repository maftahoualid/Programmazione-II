# Laboratorio del 11/10/2024, ore 12:30 - 14:30, aula Delta
...
Si facciano i seguenti esercizi, senza usare funzioni di libreria che risolvono esattamente tali
problemi

1. Si scriva un programma il cui main legge un intero non negativo da tastiera (se negativo,
lo richiede ad oltranza) e lo trasforma in una stringa che rappresenta lo stesso numero in
binario, che infine stampa. Per esempio, se viene immesso l’intero 123, deve costruire e poi
stampare la stringa ”1111011”.

2. Si faccia la stessa cosa in ottale e in esadecimale.

3. Si faccia la stessa cosa in Base58, che è una numerazione le cui cifre sono le cifre arabe da
1 a 9, seguite dalle lettere alfabetiche maiuscole (tranne O e I) e poi dalle lettere alfabetiche
minuscole (tranne la l). Si veda la descrizione qui.

4. Si scriva un programma Java che legge una frase da tastiera e determina se tale frase è
palindroma.
...
- 💻 [**`Base58.java`**](soluzione/Base58.java)
- 💻 [**`Binary.java`**](soluzione/Binary.java)
- 💻 [**`Hexadecimal.java`**](soluzione/Hexadecimal.java)
- 💻 [**`Hexadecimal2.java`**](soluzione/Hexadecimal2.java)
- 💻 [**`Octal.java`**](soluzione/Octal.java)
- 💻 [**`Palindrome.java`**](soluzione/Palindrome.java)

## Collegamenti e Riferimenti Esterni

- [Base58 Encoding (Learn Me A Bitcoin)](https://learnmeabitcoin.com/technical/base58)
...
<nav class="lesson-nav" style="position: fixed; top: 24px; right: 20px; width: 125px; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', 'Noto Sans', Helvetica, Arial, sans-serif; font-size: 11px; line-height: 1.45; border-left: 1px solid #d0d7de; padding-left: 10px; z-index: 100;">
  ...
  <div style="display: flex; gap: 8px; margin-bottom: 8px; font-size: 10px; color: #656d76;">
    <a href="../07_Lezione_2024-10-10/README.md" style="color: #0969da; text-decoration: none;" title="Lezione del 10/10/2024, ore 16:00 - 18:00, aula Magna">← Prec</a>
    <span style="color: #d0d7de;">|</span>
    <a href="../09_Lezione_2024-10-11/README.md" style="color: #0969da; text-decoration: none;" title="Lezione dell'11/10/2024, ore 14:30 - 15:30, aula Delta">Succ →</a>
  </div>
  <ul style="list-style: none; margin: 0; padding: 0; max-height: calc(100vh - 80px); overflow-y: auto; scrollbar-width: thin;">
    ...
    <li style="margin: 2px 0; font-weight: 600; color: #0969da; white-space: nowrap; overflow: hidden; text-overflow: ellipsis;" title="Laboratorio del 11/10/2024, ore 12:30 - 14:30, aula Delta">08. Lab 11/10</li>
