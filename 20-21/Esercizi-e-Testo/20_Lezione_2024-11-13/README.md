# Lezione del 13/11/2024, ore 13:30 - 14:30, aula Magna
...
Parametri varargs. Esempio per i costruttori delle classi Formation e Formation433 dell’ultimo
laboratorio. Tipi generici: variabili di tipo nella dichiarazione di una classe e di una interfaccia.
L’interfaccia di libreria Comparable<T>. Vincoli sulle variabili di tipo. Esempio di un metodo per
restituire il minimo di un array non vuoto di Comparable<T>.

### Metodi di uso frequente della classe java.lang.Comparable<T>
...
### Esempio del minimo di un array di Comparable

- 💻 [**`AbstractSoccerPlayer.java`**](esempi_minimo_comparable/AbstractSoccerPlayer.java)
- 💻 [**`Date.java`**](esempi_minimo_comparable/Date.java)
- 💻 [**`Defence.java`**](esempi_minimo_comparable/Defence.java)
- 💻 [**`Formation.java`**](esempi_minimo_comparable/Formation.java)
- 💻 [**`Formation433.java`**](esempi_minimo_comparable/Formation433.java)
- 💻 [**`Forward.java`**](esempi_minimo_comparable/Forward.java)
- 💻 [**`GoalKeeper.java`**](esempi_minimo_comparable/GoalKeeper.java)
- 💻 [**`Main.java`**](esempi_minimo_comparable/Main.java)
- 💻 [**`Main2.java`**](esempi_minimo_comparable/Main2.java)
- 💻 [**`MainFormations.java`**](esempi_minimo_comparable/MainFormations.java)
- 💻 [**`Midfield.java`**](esempi_minimo_comparable/Midfield.java)
- 💻 [**`Pair.java`**](esempi_minimo_comparable/Pair.java)
- 💻 [**`Pair1.java`**](esempi_minimo_comparable/Pair1.java)
- 💻 [**`Pair2.java`**](esempi_minimo_comparable/Pair2.java)
- 💻 [**`Pair3.java`**](esempi_minimo_comparable/Pair3.java)
- 💻 [**`SoccerPlayer.java`**](esempi_minimo_comparable/SoccerPlayer.java)
...
- [Comparable](https://docs.oracle.com/javase/9/docs/api/java/lang/Comparable.html)
...
<nav class="lesson-nav" style="position: fixed; top: 24px; right: 20px; width: 125px; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', 'Noto Sans', Helvetica, Arial, sans-serif; font-size: 11px; line-height: 1.45; border-left: 1px solid #d0d7de; padding-left: 10px; z-index: 100;">
  ...
  <div style="display: flex; gap: 8px; margin-bottom: 8px; font-size: 10px; color: #656d76;">
    <a href="../19_Laboratorio_2024-11-08/README.md" style="color: #0969da; text-decoration: none;" title="Laboratorio dell'8/11/2024, ore 12:30 - 14:30, aula Delta">← Prec</a>
    <span style="color: #d0d7de;">|</span>
    <a href="../21_Lezione_2024-11-14/README.md" style="color: #0969da; text-decoration: none;" title="Lezione del 14/11/2024, ore 13:30 - 15:30, aula Magna">Succ →</a>
  </div>
  <ul style="list-style: none; margin: 0; padding: 0; max-height: calc(100vh - 80px); overflow-y: auto; scrollbar-width: thin;">
    ...
    <li style="margin: 2px 0; font-weight: 600; color: #0969da; white-space: nowrap; overflow: hidden; text-overflow: ellipsis;" title="Lezione del 13/11/2024, ore 13:30 - 14:30, aula Magna">20. 13/11</li>
