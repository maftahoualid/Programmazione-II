# Lezione del 4/10/2024, ore 17:30 - 18:30, aula Tessari
...
I due mondi dei tipi primitivi e dei tipi riferimento. Assenza di conversioni di tipo fra i due mondi
(implicite o esplicite). I tipi primitivi non hanno metodi! Il valore speciale null per variabili
di tipo riferimento. Mai chiamare metodi o accedere a null! Concatenazione di un oggetto a
una stringa con l’operatore + e stampa di un oggetto con System.out.println() (e simili):
conseguente chiamata implicita a toString().

## Materiali Didattici ed Esercizi

### Esempi

- 💻 [**`Cornice.java`**](esempi/Cornice.java)
- 💻 [**`Cornice2.java`**](esempi/Cornice2.java)
- 💻 [**`Inizializzazione.java`**](esempi/Inizializzazione.java)
...
<nav class="lesson-nav" style="position: fixed; top: 24px; right: 20px; width: 125px; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', 'Noto Sans', Helvetica, Arial, sans-serif; font-size: 11px; line-height: 1.45; border-left: 1px solid #d0d7de; padding-left: 10px; z-index: 100;">
  ...
  <div style="display: flex; gap: 8px; margin-bottom: 8px; font-size: 10px; color: #656d76;">
    <a href="../04_Laboratorio_2024-10-04/README.md" style="color: #0969da; text-decoration: none;" title="Laboratorio del 4/10/2024, 12:30 - 14:30, aula Delta">← Prec</a>
    <span style="color: #d0d7de;">|</span>
    <a href="../06_Lezione_2024-10-09/README.md" style="color: #0969da; text-decoration: none;" title="Lezione del 9/10/2024, ore 13:30 - 14:30, aula Magna">Succ →</a>
  </div>
  <ul style="list-style: none; margin: 0; padding: 0; max-height: calc(100vh - 80px); overflow-y: auto; scrollbar-width: thin;">
    ...
    <li style="margin: 2px 0; font-weight: 600; color: #0969da; white-space: nowrap; overflow: hidden; text-overflow: ellipsis;" title="Lezione del 4/10/2024, ore 17:30 - 18:30, aula Tessari">05. 04/10</li>
