# Lezione del 12/12/2024, ore 16:30 - 18:30, aula Magna
...
Esempio dell’iterabile delle sequenze lessicografiche. Concorrenza. La classe java.lang.Thread. Race condition. Deadlock. Il costrutto synchronized. Classi e oggetti
immutabili. Esempio del calcolo delle auto-frasi in maniera sequenziale e parallela.
...
- `static Thread currentThread() (ritorna il thread che sta eseguendo il codice chiamante) Ɗ Constants.java`

## Materiali Didattici ed Esercizi

### Risorse e Documenti

- 💻 [**Constants.java**](esempi/Constants.java)

### Esempi

- 💻 [**`AutoSentences.java`**](esempi/AutoSentences.java)
- 💻 [**`AutoSentencesThread.java`**](esempi/AutoSentencesThread.java)
- 💻 [**`Constants.java`**](esempi/Constants.java)
- 💻 [**`Sentence.java`**](esempi/Sentence.java)
- 💻 [**`Sequences.java`**](esempi/Sequences.java)
...
- [Thread](https://docs.oracle.com/javase/9/docs/api/java/lang/Thread.html)
...
<nav class="lesson-nav" style="position: fixed; top: 24px; right: 20px; width: 125px; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', 'Noto Sans', Helvetica, Arial, sans-serif; font-size: 11px; line-height: 1.45; border-left: 1px solid #d0d7de; padding-left: 10px; z-index: 100;">
  ...
  <div style="display: flex; gap: 8px; margin-bottom: 8px; font-size: 10px; color: #656d76;">
    <a href="../29_Lezione_2024-12-11/README.md" style="color: #0969da; text-decoration: none;" title="Lezione dell'11/12/2024, ore 13:30 - 14:30, aula Magna">← Prec</a>
    <span style="color: #d0d7de;">|</span>
    <a href="../31_Laboratorio_2024-12-13/README.md" style="color: #0969da; text-decoration: none;" title="Laboratorio del 13/12/2024, ore 12:30 - 14:30, aula Delta">Succ →</a>
  </div>
  <ul style="list-style: none; margin: 0; padding: 0; max-height: calc(100vh - 80px); overflow-y: auto; scrollbar-width: thin;">
    ...
    <li style="margin: 2px 0; font-weight: 600; color: #0969da; white-space: nowrap; overflow: hidden; text-overflow: ellipsis;" title="Lezione del 12/12/2024, ore 16:30 - 18:30, aula Magna">30. 12/12</li>
