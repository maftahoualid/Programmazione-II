# Programmazione II - Introduzione

## Informazioni sulla Lezione

- **Tipo**: Introduzione al corso

## Argomenti Trattati

La parte di Programmazione 2 verrà effettuata in presenza, sia per la parte di teoria che per la
parte di laboratorio.
Per lavorare da casa, gli studenti sono invitati a installare Eclipse (o equivalente) sul proprio
computer, con supporto per Java almeno versione 9, in modo da potere effettuare da casa gli
esercizi del laboratorio.
L’esame della parte di Programmazione 2 consiste nella scrittura o modifica di programmi Java,
al calcolatore. Gli esami verranno effettuati sui computer dei laboratori didattici dell’Università.
Durante l’esame è possibile consultare materiale didattico, appunti e libri, ma internet non sarà
disponibile. Programmi che non compilano non saranno valutati. Il voto complessivo sarà la
media del voto di Programmazione 2 e del voto di Ingegneria del Software.
Chi fosse impossibilitato a seguire le lezioni in presenza può fare riferimento alle registrazioni
delle lezioni passate.

## Collegamenti e Riferimenti Esterni

- [Registrazioni video delle lezioni passate (Dropbox - ~20.7 GB)](https://www.dropbox.com/scl/fo/zy1hrllypnnyffpko7yan/ACJrOS3-JT55hvf3JKiA-ZY?rlkey=94ij4mv57vpjaly8dkquwkgdb&st=9xkvljio&dl=0)
- [Compiti degli anni passati con soluzione (Repository GitHub)](https://github.com/spoto/ProgrammazioneJava/)
...
<nav class="lesson-nav" style="position: fixed; top: 24px; right: 20px; width: 125px; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', 'Noto Sans', Helvetica, Arial, sans-serif; font-size: 11px; line-height: 1.45; border-left: 1px solid #d0d7de; padding-left: 10px; z-index: 100;">
  ...
  <div style="display: flex; gap: 8px; margin-bottom: 8px; font-size: 10px; color: #656d76;">
    <span style="color: #8c959f; cursor: default;">← Prec</span>
    <span style="color: #d0d7de;">|</span>
    <a href="../02_Lezione_2024-10-02/README.md" style="color: #0969da; text-decoration: none;" title="Lezione del 2/10/2024, 13:30 - 14:30, aula Magna">Succ →</a>
  </div>
  <ul style="list-style: none; margin: 0; padding: 0; max-height: calc(100vh - 80px); overflow-y: auto; scrollbar-width: thin;">
    <li style="margin: 2px 0; font-weight: 600; color: #0969da; white-space: nowrap; overflow: hidden; text-overflow: ellipsis;" title="Programmazione II - Introduzione">01. Intro</li>
